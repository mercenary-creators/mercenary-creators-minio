...
public class LogbackLoggerFactory implements ILoggerFactory
{
    ...
    {
        return loggers.computeIfAbsent(MinioUtils.requireToString(name), LogbackLogger::new);
    }
    ...
    protected static class LogbackLogger implements ILogger, WithLoggerOf<Logger>
    {
        @NonNull
        private final Logger logs;

        protected LogbackLogger(@NonNull final String name)
        {
